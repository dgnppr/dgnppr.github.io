---
layout  : wiki
title   : 메달리언 레이어 설계 기준 — 무엇을 어디에 둘 것인가
date    : 2026-06-25 00:00:00 +0900
updated : 2026-06-25 00:00:00 +0900
tag     : data-engineering data-architecture design-pattern
toc     : true
comment : true
public  : true
...
> [[/data-engineering/00_what_is_medaliion_architecture]]에서 레이어가 무엇인지, [[/data-engineering/01_how_to_architect_medallion_well]]에서 소스 변경을 흡수하지 못한 사고를 봤다. 레이어가 무엇인지는 안다. 문제는 매번 *어느 레이어에 둘지* 판단해야 한다는 것이다.
...
- [[/data-engineering/00_what_is_medaliion_architecture]] — Bronze·Silver·Gold 각 계층의 정의와 핵심 원칙
- [[/data-engineering/01_how_to_architect_medallion_well]] — 소스 변경을 흡수하지 못한 실제 사고와 Silver의 역할
