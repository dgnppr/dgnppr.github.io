...
> [[/data-engineering/00_what_is_medaliion_architecture]] 에서 Medallion을 Bronze·Silver·Gold 세 계층으로 설명했다. 이 글은 그 구조가 왜 필요한지를 실제 장애에서 거꾸로 읽는다.
...
- [[/data-engineering/00_what_is_medaliion_architecture]] — Bronze·Silver·Gold 각 계층의 책임과 핵심 원칙
