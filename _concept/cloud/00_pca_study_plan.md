...
- **[Altostrat Media](https://services.google.com/fh/files/misc/v6.1_pca_altostrat_media_case_study_english.pdf)** (미디어 GenAI·하이브리드 GKE) — 딥다이브 [[/concept/cloud/14_case_altostrat_media_for_pca]]
- **[Cymbal Retail](https://services.google.com/fh/files/misc/v6.1_pca_cymbal_retail_case_study_english.pdf)** (커머스 GenAI·카탈로그·대화형) — 딥다이브 [[/concept/cloud/15_case_cymbal_retail_for_pca]]
- **[EHR Healthcare](https://services.google.com/fh/files/misc/v6.1_pca_ehr_healthcare_case_study_english.pdf)** (하이브리드·컨테이너·규제) — 딥다이브 [[/concept/cloud/16_case_ehr_healthcare_for_pca]]
- **[KnightMotives Automotive](https://services.google.com/fh/files/misc/v6.1_pca_knightmotives_automotive_case_study_english.pdf)** (자율주행·데이터 수익화·EU 규제) — 딥다이브 [[/concept/cloud/17_case_knightmotives_automotive_for_pca]]
